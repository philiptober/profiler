...
profilerApp.controller('homeController', function ($scope) {
	...
	$scope.IntroOptions = {
        steps:[
			...
			{
				element: document.querySelector('[data-step="4&11"]'),
				intro: "There is also a placeholder for a picture. Although it is but an icon, " +
					"Image support is an upcoming feature."
			},
			{
				element: document.querySelector('[data-step="5&6"]'),
				intro: "Using this button, you can display the profile as disabled (not active or however you want to call it)." +
					"<br><br><em>Please click it.</em>"
			},
			{
				element: document.querySelector('[data-step="5&6"]'),
				intro: "Now the profile is being marked as enabled (active)."
			},
			{
			...
			{
				element: document.querySelector('[data-step="17"]'),
			...
			{
				element: document.querySelector('[data-step="18"]'),
